...
export default function Frame() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative size-full">
      <div className="bg-[#fa7319] content-stretch flex gap-[8px] items-center overflow-clip p-[8px] relative rounded-[8px] shrink-0 w-[390px]" data-name="Alert & Notification & Toast [1.1]">
      ...
      <div className="bg-[#ffd9c0] content-stretch flex gap-[8px] items-center overflow-clip p-[8px] relative rounded-[8px] shrink-0 w-[390px]" data-name="Alert & Notification & Toast [1.1]">
        <div className="overflow-clip relative shrink-0 size-[16px]" data-name="alert-fill">
          <div className="absolute inset-[14.58%_12.5%_18.75%_12.5%]" data-name="Vector">
            <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12 10.6667">

      ...
      <div className="px-4 py-4 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <span className="text-muted-foreground" style={{ fontSize: '13px' }}>Partner Portal</span>
          </div>
        </div>
      </div>
      ...
      <div className="p-3 border-t border-border">
        <div className="flex items-center gap-2 px-2 py-1.5">
          ...
          <div className="flex-1 overflow-hidden">
            <p style={{ fontSize: '12px' }} className="truncate">Chisom Okafor</p>
            <p className="text-muted-foreground truncate" style={{ fontSize: '13px' }}>Compliance Consultant</p>
          </div>
        </div>
      </div>
    </div>
